...
workflow.add_node("show_items", show_items, retry_policy=RetryPolicy(max_attempts=3, initial_interval=0.5))
workflow.add_node("add_item", add_item, retry_policy=RetryPolicy(max_attempts=3, initial_interval=0.5))
workflow.add_node("update_item", update_item, retry_policy=RetryPolicy(max_attempts=3, initial_interval=0.5))
